...
class MQTT:
    ...
    sub_topics = [("620146473_pub", 0), ("620146473", 0), ("620146473_sub", 0)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
    ...
    def __init__(self,mongo):
        ...
        self.client.message_callback_add("620146473", self.update)
        self.client.message_callback_add("620146473_sub", self.update)
        self.client.message_callback_add("620146473_pub", self.update)
